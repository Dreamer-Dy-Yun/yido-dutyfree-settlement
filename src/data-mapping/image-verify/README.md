...
- `ImageVerifyModal.jsx` owns save/delete orchestration and calls backend only through `src/api/data-mapping/reviewApi.js`.
- `useImageVerifyDetailState.js` loads image detail through `src/api/data-mapping/imageAssetApi.js`.
