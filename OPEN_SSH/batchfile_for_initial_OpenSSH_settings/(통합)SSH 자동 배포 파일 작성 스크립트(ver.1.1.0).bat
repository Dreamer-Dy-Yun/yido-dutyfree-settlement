:: Tool name : (통합)SSH 자동 배포 파일 작성 스크립트(ver.1.1.0)
:: Written by : 윤대영
:: Contact : Dreamer.Dy.Yun@gmail.com
:: Created at : 2025.06.26
:: Updated at : 2025.07.24
:: Supported by : ChatGPT-4o, ChatGPT-o3
:: Note : "우클릭>관리자 권한 실행"을 위해 CMD, PowerShell 혼용
...
:: ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
echo echo [🔐] User권한 공개키 등록 중... >> "%SSH_DEPLOY_SCRIPT_PATH%"
...
set "msg_succeed='    >> [O] User권한 공개키 등록 성공%'"
set "msg_failed='    >> [X] User권한 공개키 등록 실패%'"
set "pscmd="
...
:: ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
echo echo [🔐] Admin권한 공개키 등록 중... >> "%SSH_DEPLOY_SCRIPT_PATH%"
...
echo echo [🔗] 방화벽 예외 허용... >> "%SSH_DEPLOY_SCRIPT_PATH%"
