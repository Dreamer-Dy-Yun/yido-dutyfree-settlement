...
| `router_tenant.py` | `/api/tenant` | Tenant user management, EDI APIs, image upload/OCR/review, matching, receipt/passport verification, usage, tenant info, internal worker endpoints. |
| `router_system_admin.py` | `/api/system-admin` | Provider admin dashboard, tenant approval/lifecycle, service accounts, LLM API keys, prompts. |
